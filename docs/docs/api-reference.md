...
- [Collections](api/collections.html)
    - [.all](api/promise.all.html)
    - [.props](api/promise.props.html)
    - [.any](api/promise.any.html)
    - [.race](api/promise.race.html)
    - [.some](api/promise.some.html)
    - [.map](api/promise.map.html)
    - [.reduce](api/promise.reduce.html)
    - [.filter](api/promise.filter.html)
    - [.each](api/promise.each.html)
...
- [Configuration](api/error-management-configuration.html)
    - [Rejection events](api/global-rejection-events.html)
